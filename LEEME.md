...
La fecha debe estar en el formato dd/mm/aaaa, la hora debe estar en formato de 24 horas. Las mediciones tienen que tener una frequencia de 15 min o 1 hora. Si los archivos no están en este formato definido PPCC no podrá analizar los datos correctamente y el programa podría dejar de funcionar. PPCC no verifica las unidades y asume que todos los valores tienen como unidad kW. Los nombres de las columnas (fecha, hora, kW) no importan: Serán utilizadas para nombrar a los ejes de los diagramas, pero esto se puede cambiar a la hora de generar los diagramas. 
